        ...
        void insert(OctreePoint* point) {
            ...
            if (isLeafNode()) {
                if (data == NULL) {
                    ...
                    //std::cout << "new location:" << getOctantContainingPoint(point->getPosition()) << std::endl;

                    switch (getOctantContainingPoint(oldPoint->getPosition()))
                    {
                    case 0:
                        p += "000";
                        break;
                    ...
                    switch (getOctantContainingPoint(point->getPosition()))
                    {
                        case 0:
                            p += "000";
                            break;
